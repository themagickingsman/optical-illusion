      ...
      <div style={{ 
        ...
        <div style={{ marginTop: '80px', display: 'flex', flexDirection: 'column', alignItems: 'center', transform: 'translateY(-40px)' }}>
          ...
          <div style={{ display: "flex", gap: "25px", marginTop: "65px" }}>
            <a href="#" className="social-btn" style={{ display: "flex", justifyContent: "center", alignItems: "center", width: "60px", height: "60px", borderRadius: "50%", background: "rgba(255, 255, 255, 0.05)", border: "1px solid rgba(255, 255, 255, 0.2)", color: "#fff", textDecoration: "none", backdropFilter: "blur(20px)" }}>
