...
/** Merge saved in-memory data with DEFAULT so new fields are never undefined. */
...
export default function NexusCore({ showControls = true, storageKey = DEFAULT_LS_KEY }: NexusCoreProps) {
  ...
  // Re-read config disabled as state is transient in-memory.
  useEffect(() => {
    // REMOVED: localStorage storage event listener per architectural rules.
  }, []);
