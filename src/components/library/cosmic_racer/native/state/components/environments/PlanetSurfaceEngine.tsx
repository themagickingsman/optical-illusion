...
import { useBuildingsCMS, BuildingArchetype } from '../../../components/dashboard/environments/BuildingsCMSData';
import Link from 'next/link';
import { BuildingIcon } from '../../../components/dashboard/BuildingIcon';
    ...
    <div style={{ width: '100vw', height: '100vh', position: 'relative', background: bgMode === 'dots' ? '#ffffff' : '#050511', overflow: 'hidden' }}>
      ...
      <div style={{
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
              {buildingsDB.map((b: BuildingArchetype) => (
                  <button 
                      key={b.id}
