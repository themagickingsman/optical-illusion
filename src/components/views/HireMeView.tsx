...
export default function HireMeView() {
  ...
  return (
    ...
    <div style={{ position: "absolute", bottom: "-165px", left: "50%", transform: "translateX(-50%)", display: "flex", gap: "25px", zIndex: 100 }}>
        <a href="#" className="social-btn" style={{ display: "flex", justifyContent: "center", alignItems: "center", width: "80px", height: "80px", borderRadius: "50%", background: "rgba(255, 255, 255, 0.05)", border: "1px solid rgba(255, 255, 255, 0.2)", color: "#fff", textDecoration: "none", backdropFilter: "blur(20px)" }}>
